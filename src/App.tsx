...
const ApplicationRenewal = React.lazy(
  () => import("./components/applications/ApplicationRenewal"),
);
const ApplicationDetails = React.lazy(
  () => import("./components/applications/ApplicationDetails"),
);
        ...
        >
          ...
          <Route path="applications">
            ...
            <Route
              ...
              element={
                <RoleProtectedRoute
                  allowedRoles={["admin", "reviewer", "institution"]}
                >
                  <Suspense fallback={<LoadingState />}>
                    <ApplicationDetails />
                  </Suspense>
          ...
          <Route
            ...
            element={
              <RoleProtectedRoute
                allowedRoles={["admin", "institution", "reviewer"]}
              >
                <Suspense fallback={<LoadingState />}>
                  <DocumentsPage />
                </Suspense>
